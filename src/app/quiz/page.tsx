...
const questions: Question[] = [
    {
        ...
        type: 'color-only',
        options: [
            { id: 'tone-1', text: 'Porcelana', color: '#FFF5EB' },
            { id: 'tone-2', text: 'Clara rosada', color: '#FFE8DC' },
            { id: 'tone-3', text: 'Clara', color: '#FFD9C4' },
            { id: 'tone-4', text: 'Bege claro', color: '#ECC5A8' },
            { id: 'tone-5', text: 'Bege', color: '#D4A574' },
            { id: 'tone-6', text: 'Morena clara', color: '#C49A6C' },
            { id: 'tone-7', text: 'Morena', color: '#A67B50' },
            { id: 'tone-8', text: 'Morena escura', color: '#8B6B4F' },
            { id: 'tone-9', text: 'Negra clara', color: '#6B4F3A' },
            { id: 'tone-10', text: 'Negra', color: '#4A3728' },
            { id: 'tone-11', text: 'Negra escura', color: '#3A2A1E' },
            { id: 'tone-12', text: 'Negra retinta', color: '#2C1D12' },
        ],
    },
    {
        id: 2,
